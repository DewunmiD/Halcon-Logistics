...
const Pagefour = () => {
  ...
  return (
    ...
    <div className="flex justify-between mt-4">
      ...
      <h1 className='ml-[20px] font-bold text-3xl '>All<p><div className="w-6/6 border-b-black border-b-2"></div></p></h1>
    <h1 className='font-bold text-3xl'><a href="/Pagefive">Active</a></h1>
    <h1 className='font-bold text-3xl mr-[20px]'><a href="/Pagesix">Offline</a></h1>
    </div>
    <img
