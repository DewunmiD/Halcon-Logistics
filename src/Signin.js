    ...
    <div className='w-full !px-0 !mx-0 !overflow-hidden'>
      <form className="signin-form flex flex-col space-y-6 px-8 py-12">
        ...
        <div className='relative flex items-center flex-grow mx-auto'>
          ...
          <input type='email' placeholder='Email:' className='sm:w-80 h-12 border rounded pl-8 text-black md:w-96' />
        </div>

        <div className='relative flex items-center flex-grow mx-auto'>
          <MdLock className='absolute left-3' />
          <input type='password' placeholder='Password:' className='sm:w-80 h-12 border rounded pl-8 text-black md:w-96' />
        </div>
